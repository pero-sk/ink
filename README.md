...
Ink has built-in help for its command language. Use the bare `?` modifier to inspect some available commands and their usage rather, and get basic information about ink
